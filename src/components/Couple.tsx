...
const Couple = () => {
  return (
    <section id="couple" className="py-12 sm:py-16 lg:py-20 bg-rose-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start">
          {/* Bride Section */}
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden group hover:shadow-xl transition-all duration-300 w-full">
            <div className="relative overflow-hidden">
              <img
                src={mrudula}
                alt="Lade Mrudula - The Bride"
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              <h3 className="text-2xl sm:text-3xl font-serif font-bold text-gray-900 mb-2">Mrudula Lade</h3>
              <p className="text-gray-900 font-medium mb-4 sm:mb-6">Software Engineer</p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-sm">
                  <div className="flex items-center">
                    <Laptop2 className="w-4 h-4 text-rose-500 mr-2 flex-shrink-0" />
                    <span className="text-gray-600">Tech Savvy</span>
                  </div>
                  <div className="flex items-center">
                    <Music className="w-4 h-4 text-rose-500 mr-2 flex-shrink-0" />
                    <span className="text-gray-600">Music Lover</span>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden group hover:shadow-xl transition-all duration-300 w-full">
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              <h3 className="text-2xl sm:text-3xl font-serif font-bold text-gray-900 mb-2">Pavan Kumar Varanasi</h3>
              <p className="text-slate-600 font-medium mb-4 sm:mb-6">Senior Embedded Software Engineer</p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-sm">
                  <div className="flex items-center">
                    <Laptop className="w-4 h-4 text-slate-600 mr-2 flex-shrink-0" />
                    <span className="text-gray-600">Techie</span>
                  </div>
                  <div className="flex items-center">
                    <Plane className="w-4 h-4 text-slate-600 mr-2 flex-shrink-0" />
                    <span className="text-gray-600">Travel Lover</span>
                  </div>
                </div>
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20 text-center">
          <div className="bg-white rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg max-w-4xl mx-auto">
            <Heart className="mx-auto mb-4 text-rose-500" size={32} />
            <h3 className="text-xl sm:text-2xl font-serif font-bold text-gray-900 mb-4 sm:mb-6">
              Perfect Together
            </h3>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 text-sm text-gray-500">
              <span className="mb-2 sm:mb-0">Shared Loves:</span>
              <span className="bg-rose-100 px-3 py-1 rounded-full">Coffee</span>
              <span className="bg-rose-100 px-3 py-1 rounded-full">Travel</span>
              <span className="bg-rose-100 px-3 py-1 rounded-full">Sunsets</span>
              <span className="bg-rose-100 px-3 py-1 rounded-full">Adventure</span>
