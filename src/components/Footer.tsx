        ...
        <div className="text-center">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-8">
              <a href="mruduvan@pavanmrudulaforever.online" className="flex items-center text-gray-300 hover:text-white transition-colors">
                <Mail className="mr-2" size={16} />
                mruduvan@pavanmrudulaforever.online
              </a>
...
*/}
          ...
          <div className="mb-8 py-8 border-b border-gray-700">
            <div className="text-2xl font-serif mb-2">19 February 2026</div>
          ...
          <div className="text-sm text-gray-400">
            <blockquote className="text-lg font-serif italic text-gray-300 mb-2">
             © 2025 Mrudula & Pavan Kumar. Made with love.
            </blockquote>
            
            <br/>
             <a href="https://www.matricservices.in" target='_blank' className=" text-gray-600 hover:text-gray-900 transition-colors">
                         <cite className="text-sm text-gray-400 ">
               — Designed by Matrics Services
